...
// function fetchHTML(results, topic) {
// 	let successNumber = 1;
// 	let errorNumber = 1;
// 	results.forEach(async function(result){
// 		try{
// 			const metadata = await metascraper.scrapeUrl(result.pageUrl);
// 			console.log("METADATA", metadata);
// 			console.log("SUCCESS" + topic + successNumber);
// 			successNumber++;
// 			return Promise.resolve(metadata);
// 		}
// 		catch (error){
// 			console.log("ERROR" + topic + errorNumber);
// 			errorNumber++;
